...
// (docs/API.md ≈ 1056, docs/CLI.md ≈ 1848 after #1598's "Source Control
// (SCM) Commands" section, docs/MCP.md ≈ 809, src/slack/commands/tasks-command.ts
// ≈ 1050) push this ceiling; kept in step with the docs/CLI.md line budget in
// scripts/agent-context/manifest.ts (1950). Tighten when those files are split
// per the AGENT_CONTEXT.md budgets.
const MAX_LINES_PER_PROBE_FILE = 1950;
